...
LoadedModel(
    sig::ModelSignature, execs::Union{Dict{Int, Any}, Dict{VariantKey, Dict{Int, Any}}},
...
LoadedModel(
    sig::ModelSignature, execs::Dict{Int, Any}, weights::Union{Vector{Any}, Nothing},
...
function ModelSchedState(name::AbstractString, mc::ModelSchedConfig, now::Float64)
    return ModelSchedState(
        String(name), mc.weight, mc.max_batch_size, QueuedRequest[],
